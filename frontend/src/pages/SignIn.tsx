...
const SignIn = () => {
    ...
    return (
       <form className="flex flex-col gap-5 border border-gray-300 shadow-lg p-6 rounded-md bg-gray-200" onSubmit={onSubmit}>
            ...
            <span className="flex items-center justify-between">
                ...
                <button type="submit" className="bg-blue-600 text-white p-2 font-medium hover:text-orange-400 rounded-sm">Log In</button>
            </span>
       </form>
    );
};
